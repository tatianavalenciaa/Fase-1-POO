...
public class UsuariosForm extends javax.swing.JInternalFrame {
    ...
    private Object[][] convertirAFilasDeTabla(List<Usuario> usuarios) {
        Object[][] matriz = new Object[usuarios.size()][5];

        for (int i = 0; i < usuarios.size(); i++) {
            Usuario usuario = usuarios.get(i);
            matriz[i][0] = usuario.getIdUsuario();
            matriz[i][1] = usuario.getNombre();
            matriz[i][2] = usuario.getCarnet();
            matriz[i][3] = usuario.getPassword();
            matriz[i][4] = usuario.getRol();
        }
    ...
    private void pintarTabla() {
        ...
        try {
            ...
            String[] titulosTabla = new String[] {"Id", "Nombre", "Carnet", "Password", "Rol"};
